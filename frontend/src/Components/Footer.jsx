...
function Footer() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-black text-white pt-4 xl:px-32">
        ...
        <hr className="mx-8 lg:mx-32 border-gray-400" />

        <div className='flex flex-col px-6 lg:flex-row justify-center py-12 items-center'>
          <div className="flex flex-col md:flex-row justify-center gap-8 lg:gap-16 py-8 px-8">
            <div>
              <ul className="italic font-extralight">
                ...
                <li className="w-48">Plot no-3, Hasnpur, I.P. Ext, Patparganj, Delhi, 110092</li>
            ...
            <div>
              ...
              <ul className="italic font-extralight pt-4 space-y-2">
                <li>Home</li>
                <li>About</li>
                <li>Our Work</li>
          ...
          <div className="flex justify-center lg:justify-start">
            <iframe
              className="rounded-lg w-full h-60 lg:h-72 lg:w-full aspect-video"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7003.782445162371!2d77.30505946990519!3d28.633022087975!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfb35f4aa5cdb%3A0xacb11442f9e99d05!2sDessign%20Studio!5e0!3m2!1sen!2sin!4v1730462917090!5m2!1sen!2sin"
              loading="lazy"
        ...
        <hr className="mx-8 lg:mx-32 border-gray-400" />
        <p className="py-4 text-gray-500 italic flex gap-2 items-center justify-center text-center">
          <FaCopyright /> 2021. Dessign Studios. All rights reserved
        </p>
      </div>
    </>
  );
