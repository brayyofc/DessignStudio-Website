...
export const FixedWhatsappIcon = () => {
  return (
    <div className='fixed bottom-6 cursor-pointer left-12 bg-green-400 rounded-full p-2'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className='w-10 aspect-square'>
