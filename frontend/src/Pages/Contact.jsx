  ...
  return (
    <div className="text-xl text-black h-full items-center mt-20">
      ...
      <div className="flex px-20 py-10">
        <div className="w-1/2">
          <h1 className="font-bold text-4xl py-5">Keep in touch with us</h1>
          ...
          <div className="flex w-full py-5">
            <div className="w-1/2 ">
              <h3 className="font-bold py-5">Address</h3>
              <p className="text-base w-1/2">
                155 Indra Park, New Delhi 110059
              </p>
            </div>
            <div className="w-1/2">
              <h3 className="font-bold py-5">Contact</h3>
        ...
        <div className="w-1/2">
          <h1 className="font-bold text-4xl py-5">Send a message</h1>
          <div className="flex w-full py-5 justify-between gap-8">
            <input
              type="text"
              placeholder="Name"
